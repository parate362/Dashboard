...
const CampaignBoard = () => {
  ...
  return (
   <div className="container  mt-[40px]">
      ...
      <div className="flex items-center justify-between bg-white rounded-lg p-4 mb-8">
        <div className="text-sm font-bold pl-3 text-blue-700">Manage Campaign</div>
        <div className="flex space-x-4">
          <button className="flex items-center text-sm space-x-2 bg-white border border-gray-800  text-gray-800 px-4 py-2 rounded-md">
         {/*  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M3 4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v2H3V4zM3 8h14v2H3V8zm0 6h14v2H3v-2z" />
            </svg> 
            <span>Filters</span> */}<FilterListIcon className="mr-2" /> Filters
      ...
      <div className='flex justify-between items-center mb-2 mr-10'>
        ...
        <div className="grid grid-cols-4 mb-8"> 
          ...
          {savedCampaigns.map((campaign, index) => (
            <CampaignCard ke0={index} status="saved" {...campaign} />
          ))}
        </div>
      </div>
